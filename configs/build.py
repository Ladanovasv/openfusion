...
from openfusion.datasets import ICL, Replica, ScanNet, Kobuki, Live, SberRobotics
...
PARAMS = {
    ...
    "sber": {
        "dataset": SberRobotics,
        "path": "{}/SberRobotics-Isaac/{}",
        "depth_scale": 1000.0,
        "depth_max": 5.0,
        "voxel_size": 5.0 / 512,
        "block_resolution": 8,
        "block_count": 20000, # will be increased automatically if needed
        "img_size": (1280,720),
        "input_size": (640,360)
    },
...
def get_config(dataset, scene):
    ...
    params["path"] = params["path"].format(DATASET_PATH, scene)
    return params